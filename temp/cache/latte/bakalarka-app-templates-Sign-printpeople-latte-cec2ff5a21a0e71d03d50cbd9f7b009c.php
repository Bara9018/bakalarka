<?php
// source: C:\xampp\htdocs\bakalarka\app/templates/Sign/printpeople.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4457141445', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2f4767df8e_content')) { function _lb2f4767df8e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="table">
