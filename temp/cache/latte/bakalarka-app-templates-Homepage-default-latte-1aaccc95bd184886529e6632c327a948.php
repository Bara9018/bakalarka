...
list($_b, $_g, $_l) = $template->initialize('3413712573', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb523f59ef05_content')) { function _lb523f59ef05_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbcfb6f8a78e_title')) { function _lbcfb6f8a78e_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbdd27eeaf74_scripts')) { function _lbdd27eeaf74_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbd2cda7b5f6_head')) { function _lbd2cda7b5f6_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
