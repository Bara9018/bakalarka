<?php
// source: C:\xampp\htdocs\bakalarka\app/config/config.neon 
 ...
 * @property RegistrationModel $registrationModel
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'registrationmodel' => array('registrationModel'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\xampp\\htdocs\\bakalarka\\app',
			'wwwDir' => 'C:\\xampp\\htdocs\\bakalarka',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\xampp\\htdocs\\bakalarka\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\xampp\\htdocs\\bakalarka\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\xampp\\htdocs\\bakalarka\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\xampp\\htdocs\\bakalarka\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\xampp\\htdocs\\bakalarka\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\xampp\\htdocs\\bakalarka\\app/../temp/cache', $this->getService('nette.cacheJournal'));
	 ...
	 */
	public function createServiceRegistrationModel()
	{
		$service = new RegistrationModel($this->getService('nette.database.default.context'));
		return $service;
	}
